...
class UtilisateursApi:
    ...
    @validate_call
    def users_me_organizations_get(
        self,
        ...
        _param = self._users_me_organizations_get_serialize(
    ...
    @validate_call
    def users_me_organizations_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def users_me_organizations_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _users_me_organizations_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/users/me/organizations',
