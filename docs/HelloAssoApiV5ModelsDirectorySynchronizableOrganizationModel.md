...
```python
from openapi_client.models.hello_asso_api_v5_models_directory_synchronizable_organization_model import HelloAssoApiV5ModelsDirectorySynchronizableOrganizationModel
