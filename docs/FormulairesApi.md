...
from openapi_client.models.hello_asso_api_v5_models_enums_form_state import HelloAssoApiV5ModelsEnumsFormState
...
import openapi_client
from openapi_client.models.hello_asso_api_v5_models_enums_form_type import HelloAssoApiV5ModelsEnumsFormType
from openapi_client.models.hello_asso_api_v5_models_forms_form_quick_create_model import HelloAssoApiV5ModelsFormsFormQuickCreateModel
from openapi_client.models.hello_asso_api_v5_models_forms_form_quick_create_request import HelloAssoApiV5ModelsFormsFormQuickCreateRequest
from openapi_client.rest import ApiException
from pprint import pprint
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.FormulairesApi(api_client)
    organization_slug = 'organization_slug_example' # str | The organization Slug
    form_type = openapi_client.HelloAssoApiV5ModelsEnumsFormType() # HelloAssoApiV5ModelsEnumsFormType | The form type to create - only Event type is supported
    hello_asso_api_v5_models_forms_form_quick_create_request = openapi_client.HelloAssoApiV5ModelsFormsFormQuickCreateRequest() # HelloAssoApiV5ModelsFormsFormQuickCreateRequest | The body of the request. (optional)
...
import openapi_client
from openapi_client.models.hello_asso_api_v5_models_enums_form_type import HelloAssoApiV5ModelsEnumsFormType
from openapi_client.models.hello_asso_api_v5_models_forms_form_public_model import HelloAssoApiV5ModelsFormsFormPublicModel
from openapi_client.rest import ApiException
from pprint import pprint
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    form_type = openapi_client.HelloAssoApiV5ModelsEnumsFormType() # HelloAssoApiV5ModelsEnumsFormType | 
...
from openapi_client.models.hello_asso_api_v5_models_enums_form_state import HelloAssoApiV5ModelsEnumsFormState
from openapi_client.models.hello_asso_api_v5_models_enums_form_type import HelloAssoApiV5ModelsEnumsFormType
from openapi_client.models.results_with_pagination_model_form_light_model import ResultsWithPaginationModelFormLightModel
from openapi_client.rest import ApiException
from pprint import pprint
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.FormulairesApi(api_client)
    organization_slug = 'organization_slug_example' # str | The organization Slug
    states = [openapi_client.HelloAssoApiV5ModelsEnumsFormState()] # List[HelloAssoApiV5ModelsEnumsFormState] | States to filter  Available values: * `Public` - The form is publicly visible and findable on search engines * `Private` - The form is visible only with the URL, you cannot find it on search engines * `Draft` - The form is not yet published but visible if you have admin rights * `Disabled` - The form is disabled and can be reenabled by changing state to public or private (optional)
    form_types = [openapi_client.HelloAssoApiV5ModelsEnumsFormType()] # List[HelloAssoApiV5ModelsEnumsFormType] | Types to filter (optional)
