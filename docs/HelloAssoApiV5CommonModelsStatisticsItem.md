...
json = "{}"
# create an instance of HelloAssoApiV5CommonModelsStatisticsItem from a JSON string
hello_asso_api_v5_common_models_statistics_item_instance = HelloAssoApiV5CommonModelsStatisticsItem.from_json(json)
# print the JSON string representation of the object
print(HelloAssoApiV5CommonModelsStatisticsItem.to_json())

# convert the object into a dict
hello_asso_api_v5_common_models_statistics_item_dict = hello_asso_api_v5_common_models_statistics_item_instance.to_dict()
# create an instance of HelloAssoApiV5CommonModelsStatisticsItem from a dict
hello_asso_api_v5_common_models_statistics_item_from_dict = HelloAssoApiV5CommonModelsStatisticsItem.from_dict(hello_asso_api_v5_common_models_statistics_item_dict)
```
