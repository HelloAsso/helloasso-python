...
------------ | ------------- | ------------- | -------------
**data** | [**List[HelloAssoApiV5CommonModelsDirectorySynchronizableOrganizationModel]**](HelloAssoApiV5CommonModelsDirectorySynchronizableOrganizationModel.md) | Data property | [optional] 
