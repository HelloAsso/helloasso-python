...
**form_types** | [**List[HelloAssoApiV5CommonModelsEnumsFormType]**](HelloAssoApiV5CommonModelsEnumsFormType.md) | The form types : CrowdFunding, Membership, Event, Donation, PaymentForm ... | [optional] 
...
json = "{}"
# create an instance of HelloAssoApiV5CommonModelsDirectoryListFormsRequest from a JSON string
hello_asso_api_v5_common_models_directory_list_forms_request_instance = HelloAssoApiV5CommonModelsDirectoryListFormsRequest.from_json(json)
# print the JSON string representation of the object
print(HelloAssoApiV5CommonModelsDirectoryListFormsRequest.to_json())

# convert the object into a dict
hello_asso_api_v5_common_models_directory_list_forms_request_dict = hello_asso_api_v5_common_models_directory_list_forms_request_instance.to_dict()
# create an instance of HelloAssoApiV5CommonModelsDirectoryListFormsRequest from a dict
hello_asso_api_v5_common_models_directory_list_forms_request_from_dict = HelloAssoApiV5CommonModelsDirectoryListFormsRequest.from_dict(hello_asso_api_v5_common_models_directory_list_forms_request_dict)
```
