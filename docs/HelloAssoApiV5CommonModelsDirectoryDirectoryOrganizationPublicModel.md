...
json = "{}"
# create an instance of HelloAssoApiV5CommonModelsDirectoryDirectoryOrganizationPublicModel from a JSON string
hello_asso_api_v5_common_models_directory_directory_organization_public_model_instance = HelloAssoApiV5CommonModelsDirectoryDirectoryOrganizationPublicModel.from_json(json)
# print the JSON string representation of the object
print(HelloAssoApiV5CommonModelsDirectoryDirectoryOrganizationPublicModel.to_json())

# convert the object into a dict
hello_asso_api_v5_common_models_directory_directory_organization_public_model_dict = hello_asso_api_v5_common_models_directory_directory_organization_public_model_instance.to_dict()
# create an instance of HelloAssoApiV5CommonModelsDirectoryDirectoryOrganizationPublicModel from a dict
hello_asso_api_v5_common_models_directory_directory_organization_public_model_from_dict = HelloAssoApiV5CommonModelsDirectoryDirectoryOrganizationPublicModel.from_dict(hello_asso_api_v5_common_models_directory_directory_organization_public_model_dict)
```
