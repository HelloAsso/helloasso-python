...
```python
from helloasso-python.models.hello_asso_api_v5_models_directory_partner_organization_model import HelloAssoApiV5ModelsDirectoryPartnerOrganizationModel
