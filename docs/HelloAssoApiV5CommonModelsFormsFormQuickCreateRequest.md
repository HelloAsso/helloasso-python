...
------------ | ------------- | ------------- | -------------
**tier_list** | [**List[HelloAssoApiV5CommonModelsFormsTierLightModel]**](HelloAssoApiV5CommonModelsFormsTierLightModel.md) |  | [optional] 
...
**contact** | [**HelloAssoApiV5CommonModelsCommonContactModel**](HelloAssoApiV5CommonModelsCommonContactModel.md) |  | [optional] 
...
json = "{}"
# create an instance of HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest from a JSON string
hello_asso_api_v5_common_models_forms_form_quick_create_request_instance = HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.from_json(json)
# print the JSON string representation of the object
print(HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.to_json())

# convert the object into a dict
hello_asso_api_v5_common_models_forms_form_quick_create_request_dict = hello_asso_api_v5_common_models_forms_form_quick_create_request_instance.to_dict()
# create an instance of HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest from a dict
hello_asso_api_v5_common_models_forms_form_quick_create_request_from_dict = HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.from_dict(hello_asso_api_v5_common_models_forms_form_quick_create_request_dict)
```
