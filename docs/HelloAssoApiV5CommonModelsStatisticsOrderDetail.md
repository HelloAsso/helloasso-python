...
json = "{}"
# create an instance of HelloAssoApiV5CommonModelsStatisticsOrderDetail from a JSON string
hello_asso_api_v5_common_models_statistics_order_detail_instance = HelloAssoApiV5CommonModelsStatisticsOrderDetail.from_json(json)
# print the JSON string representation of the object
print(HelloAssoApiV5CommonModelsStatisticsOrderDetail.to_json())

# convert the object into a dict
hello_asso_api_v5_common_models_statistics_order_detail_dict = hello_asso_api_v5_common_models_statistics_order_detail_instance.to_dict()
# create an instance of HelloAssoApiV5CommonModelsStatisticsOrderDetail from a dict
hello_asso_api_v5_common_models_statistics_order_detail_from_dict = HelloAssoApiV5CommonModelsStatisticsOrderDetail.from_dict(hello_asso_api_v5_common_models_statistics_order_detail_dict)
```
