...
------------ | ------------- | ------------- | -------------
**items** | [**List[HelloAssoApiV5CommonModelsStatisticsShareItem]**](HelloAssoApiV5CommonModelsStatisticsShareItem.md) | Items linked to this payment and each share between the item and the payment | [optional] 
...
json = "{}"
# create an instance of HelloAssoApiV5CommonModelsStatisticsOrderPayment from a JSON string
hello_asso_api_v5_common_models_statistics_order_payment_instance = HelloAssoApiV5CommonModelsStatisticsOrderPayment.from_json(json)
# print the JSON string representation of the object
print(HelloAssoApiV5CommonModelsStatisticsOrderPayment.to_json())

# convert the object into a dict
hello_asso_api_v5_common_models_statistics_order_payment_dict = hello_asso_api_v5_common_models_statistics_order_payment_instance.to_dict()
# create an instance of HelloAssoApiV5CommonModelsStatisticsOrderPayment from a dict
hello_asso_api_v5_common_models_statistics_order_payment_from_dict = HelloAssoApiV5CommonModelsStatisticsOrderPayment.from_dict(hello_asso_api_v5_common_models_statistics_order_payment_dict)
```
