...
class HelloAssoApiV5CommonModelsStatisticsOrderItem(BaseModel):
    """
    Item on the order
    """ # noqa: E501
    payments: Optional[List[HelloAssoApiV5CommonModelsStatisticsSharePayment]] = Field(default=None, description="Payments linked to this item and each share between the item and the payment")
    ...
    __properties: ClassVar[List[str]] = ["payments", "name", "user", "priceCategory", "minAmount", "discount", "customFields", "options", "ticketUrl", "qrCode", "membershipCardUrl", "dayOfLevy", "tierDescription", "tierId", "comment", "id", "amount", "type", "initialAmount", "state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payments": [HelloAssoApiV5CommonModelsStatisticsSharePayment.from_dict(_item) for _item in obj["payments"]] if obj.get("payments") is not None else None,
            "name": obj.get("name"),
