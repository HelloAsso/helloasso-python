...
class HelloAssoApiV5CommonModelsFormsFormPublicModel(BaseModel):
    ...
    """ # noqa: E501
    organization_logo: Optional[StrictStr] = Field(default=None, description="Organization Logo", alias="organizationLogo")
    organization_name: Optional[StrictStr] = Field(default=None, description="Organization Name", alias="organizationName")
    tiers: Optional[List[HelloAssoApiV5CommonModelsFormsTierPublicModel]] = Field(default=None, description="Tiers")
    activity_type: Optional[StrictStr] = Field(default=None, description="Activity type of the event eg. \"Atelier(s) / Stage(s)\" matching one of the provided type values <a href=\"index#!/Values/Values_Get\"> provided here</a> or a custom value is allowed.", alias="activityType")
    activity_type_id: Optional[StrictInt] = Field(default=None, description="Activity type identifier", alias="activityTypeId")
    place: Optional[HelloAssoApiV5CommonModelsCommonPlaceModel] = None
    ...
    validity_type: Optional[HelloAssoApiV5CommonModelsEnumsMembershipValidityType] = Field(default=None, alias="validityType")
    personalized_message: Optional[StrictStr] = Field(default=None, description="A message customized by the organization administrator.", alias="personalizedMessage")
    banner: Optional[HelloAssoApiV5CommonModelsCommonDocumentModel] = None
    ...
    logo: Optional[HelloAssoApiV5CommonModelsCommonDocumentModel] = None
    meta: Optional[HelloAssoApiV5CommonModelsCommonMetaModel] = None
    state: Optional[HelloAssoApiV5CommonModelsEnumsFormState] = None
    ...
    form_type: Optional[HelloAssoApiV5CommonModelsEnumsFormType] = Field(default=None, alias="formType")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if organization_logo (nullable) is None
        # and model_fields_set contains the field
        if self.organization_logo is None and "organization_logo" in self.model_fields_set:
            _dict['organizationLogo'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "organizationLogo": obj.get("organizationLogo"),
            "organizationName": obj.get("organizationName"),
            "tiers": [HelloAssoApiV5CommonModelsFormsTierPublicModel.from_dict(_item) for _item in obj["tiers"]] if obj.get("tiers") is not None else None,
            "activityType": obj.get("activityType"),
            "activityTypeId": obj.get("activityTypeId"),
            "place": HelloAssoApiV5CommonModelsCommonPlaceModel.from_dict(obj["place"]) if obj.get("place") is not None else None,
            ...
            "banner": HelloAssoApiV5CommonModelsCommonDocumentModel.from_dict(obj["banner"]) if obj.get("banner") is not None else None,
            "currency": obj.get("currency"),
            "description": obj.get("description"),
            "startDate": obj.get("startDate"),
            "endDate": obj.get("endDate"),
            "logo": HelloAssoApiV5CommonModelsCommonDocumentModel.from_dict(obj["logo"]) if obj.get("logo") is not None else None,
