...
class HelloAssoApiV5CommonModelsFormsFormQuickCreateModel(BaseModel):
    """
    HelloAssoApiV5CommonModelsFormsFormQuickCreateModel
    """ # noqa: E501
    form_slug: Optional[StrictStr] = Field(default=None, alias="formSlug")
    organization_slug: Optional[StrictStr] = Field(default=None, alias="organizationSlug")
    public_url: Optional[StrictStr] = Field(default=None, alias="publicUrl")
    __properties: ClassVar[List[str]] = ["formSlug", "organizationSlug", "publicUrl"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HelloAssoApiV5CommonModelsFormsFormQuickCreateModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HelloAssoApiV5CommonModelsFormsFormQuickCreateModel from a dict"""
        if obj is None:
            return None
