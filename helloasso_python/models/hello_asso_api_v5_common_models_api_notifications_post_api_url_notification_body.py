...
class HelloAssoApiV5CommonModelsApiNotificationsPostApiUrlNotificationBody(BaseModel):
    """
    ...
    notification_type: Optional[HelloAssoApiV5CommonModelsApiNotificationsApiNotificationType] = Field(default=None, alias="notificationType")
