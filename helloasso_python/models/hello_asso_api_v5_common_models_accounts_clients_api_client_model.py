...
class HelloAssoApiV5CommonModelsAccountsClientsApiClientModel(BaseModel):
    """
    HelloAssoApiV5CommonModelsAccountsClientsApiClientModel
    """ # noqa: E501
    id: Optional[StrictStr] = None
    secret: Optional[StrictStr] = Field(default=None, description="Filled only when requested by the organization back office")
    partner_name: Optional[StrictStr] = Field(default=None, alias="partnerName")
    privileges: Optional[List[StrictStr]] = None
    domain: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "secret", "partnerName", "privileges", "domain"]
