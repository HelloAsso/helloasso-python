...
class HelloAssoApiV5CommonModelsAccountsCompanyLegalStatusModel(BaseModel):
    """
    user/payer company legal status
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Company legal status id")
    label: Optional[StrictStr] = Field(default=None, description="Company legal status label")
