...
class HelloAssoApiV5CommonModelsStatisticsItem(BaseModel):
    """
    An item of an order
    """ # noqa: E501
    ...
    payments: Optional[List[HelloAssoApiV5CommonModelsStatisticsItemPayment]] = Field(default=None, description="Payments linked to this item")
    name: Optional[StrictStr] = None
    user: Optional[HelloAssoApiV5CommonModelsStatisticsUser] = None
    ...
    discount: Optional[HelloAssoApiV5CommonModelsStatisticsItemDiscount] = None
    custom_fields: Optional[List[HelloAssoApiV5CommonModelsStatisticsItemCustomField]] = Field(default=None, description="Custom fields related to this item", alias="customFields")
    options: Optional[List[HelloAssoApiV5CommonModelsStatisticsItemOption]] = Field(default=None, description="Extra options taken with this item")
    ...
    type: Optional[HelloAssoApiV5CommonModelsEnumsTierType] = None
    initial_amount: Optional[StrictInt] = Field(default=None, description="The raw amount (without reduction)", alias="initialAmount")
    state: Optional[HelloAssoApiV5CommonModelsEnumsItemState] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payments": [HelloAssoApiV5CommonModelsStatisticsItemPayment.from_dict(_item) for _item in obj["payments"]] if obj.get("payments") is not None else None,
            "name": obj.get("name"),
            "user": HelloAssoApiV5CommonModelsStatisticsUser.from_dict(obj["user"]) if obj.get("user") is not None else None,
            "priceCategory": obj.get("priceCategory"),
            "minAmount": obj.get("minAmount"),
            "discount": HelloAssoApiV5CommonModelsStatisticsItemDiscount.from_dict(obj["discount"]) if obj.get("discount") is not None else None,
            "customFields": [HelloAssoApiV5CommonModelsStatisticsItemCustomField.from_dict(_item) for _item in obj["customFields"]] if obj.get("customFields") is not None else None,
            "options": [HelloAssoApiV5CommonModelsStatisticsItemOption.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None,
