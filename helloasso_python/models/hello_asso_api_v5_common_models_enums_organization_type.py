...
class HelloAssoApiV5CommonModelsEnumsOrganizationType(str, Enum):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of HelloAssoApiV5CommonModelsEnumsOrganizationType from a JSON string"""
