...
class HelloAssoApiV5CommonModelsDirectoryListFormsRequest(BaseModel):
    """
    ...
    form_types: Optional[List[HelloAssoApiV5CommonModelsEnumsFormType]] = Field(default=None, description="The form types : CrowdFunding, Membership, Event, Donation, PaymentForm ...", alias="formTypes")
