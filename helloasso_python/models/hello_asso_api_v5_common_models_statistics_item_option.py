...
class HelloAssoApiV5CommonModelsStatisticsItemOption(BaseModel):
    """
    ItemOption class
    """ # noqa: E501
    ...
    custom_fields: Optional[List[HelloAssoApiV5CommonModelsStatisticsItemCustomField]] = Field(default=None, description="Custom fields related to this option", alias="customFields")
