...
class HelloAssoApiV5CommonModelsDirectorySynchronizableFormModel(BaseModel):
    """
    SynchronizableFormModel class
    """ # noqa: E501
    action: Optional[HelloAssoApiV5CommonModelsEnumsRecordActionType] = None
    record: Optional[HelloAssoApiV5CommonModelsFormsFormBasicModel] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HelloAssoApiV5CommonModelsDirectorySynchronizableFormModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HelloAssoApiV5CommonModelsDirectorySynchronizableFormModel from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "record": HelloAssoApiV5CommonModelsFormsFormBasicModel.from_dict(obj["record"]) if obj.get("record") is not None else None
        })
        return _obj
