...
class HelloAssoApiV5CommonModelsTagsInternalTagModel(BaseModel):
    """
    ...
    tag_type: Optional[HelloAssoApiV5CommonModelsEnumsTagType] = Field(default=None, alias="tagType")
    tag_parent: Optional[HelloAssoApiV5CommonModelsTagsInternalTagModel] = Field(default=None, alias="tagParent")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tagParent": HelloAssoApiV5CommonModelsTagsInternalTagModel.from_dict(obj["tagParent"]) if obj.get("tagParent") is not None else None,
            "amountCollected": obj.get("amountCollected")
        })
        return _obj

# TODO: Rewrite to not use raise_errors
HelloAssoApiV5CommonModelsTagsInternalTagModel.model_rebuild(raise_errors=False)
