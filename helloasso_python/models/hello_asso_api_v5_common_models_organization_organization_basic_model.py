...
class HelloAssoApiV5CommonModelsOrganizationOrganizationBasicModel(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["url", "organizationSlug"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HelloAssoApiV5CommonModelsOrganizationOrganizationBasicModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HelloAssoApiV5CommonModelsOrganizationOrganizationBasicModel from a dict"""
        if obj is None:
            return None
