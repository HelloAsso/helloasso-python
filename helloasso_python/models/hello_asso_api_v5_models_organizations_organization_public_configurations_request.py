...
class HelloAssoApiV5ModelsOrganizationsOrganizationPublicConfigurationsRequest(BaseModel):
    """
    HelloAssoApiV5ModelsOrganizationsOrganizationPublicConfigurationsRequest
    """ # noqa: E501
    configurations: Optional[List[HelloAssoApiV5ModelsOrganizationsOrganizationPublicConfigurationModel]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configurations": [HelloAssoApiV5ModelsOrganizationsOrganizationPublicConfigurationModel.from_dict(_item) for _item in obj["configurations"]] if obj.get("configurations") is not None else None
        })
        return _obj
