...
class HelloAssoApiV5CommonModelsTagsPublicTagModel(BaseModel):
    """
    PublicNameTagModel class
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name tag")
    score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Tag score : measure tag relevance")
