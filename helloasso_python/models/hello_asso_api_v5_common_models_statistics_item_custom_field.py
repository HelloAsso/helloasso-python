...
class HelloAssoApiV5CommonModelsStatisticsItemCustomField(BaseModel):
    """
    Custom field associated with the item or option
    """ # noqa: E501
    id: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    type: Optional[HelloAssoApiV5CommonModelsEnumsFieldType] = None
    answer: Optional[StrictStr] = Field(default=None, description="Participant or user answer")
