...
class HelloAssoApiV5CommonModelsDirectorySynchronizableOrganizationModel(BaseModel):
    ...
    record: Optional[HelloAssoApiV5CommonModelsOrganizationOrganizationBasicModel] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "record": HelloAssoApiV5CommonModelsOrganizationOrganizationBasicModel.from_dict(obj["record"]) if obj.get("record") is not None else None
        })
        return _obj
