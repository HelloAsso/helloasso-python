...
class HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest(BaseModel):
    ...
    """ # noqa: E501
    tier_list: Optional[List[HelloAssoApiV5CommonModelsFormsTierLightModel]] = Field(default=None, alias="tierList")
    ...
    contact: Optional[HelloAssoApiV5CommonModelsCommonContactModel] = None
    display_contributor_name: Optional[StrictBool] = Field(default=None, description="Display contributor name for fundraiser and donation forms.", alias="displayContributorName")
    ...
    suggest_monthly_donation: Optional[StrictBool] = Field(default=None, description="Suggest monthly donation for donation forms.", alias="suggestMonthlyDonation")
    display_monthly_donations_first: Optional[StrictBool] = Field(default=None, description="The monthly donation option should be displayed or selected by default for donation forms.", alias="displayMonthlyDonationsFirst")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tierList": [HelloAssoApiV5CommonModelsFormsTierLightModel.from_dict(_item) for _item in obj["tierList"]] if obj.get("tierList") is not None else None,
            ...
            "contact": HelloAssoApiV5CommonModelsCommonContactModel.from_dict(obj["contact"]) if obj.get("contact") is not None else None,
            ...
            "suggestMonthlyDonation": obj.get("suggestMonthlyDonation"),
            "displayMonthlyDonationsFirst": obj.get("displayMonthlyDonationsFirst"),
