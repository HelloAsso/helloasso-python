...
class HelloAssoApiV5CommonModelsPartnersPartnerPublicModel(BaseModel):
    """
    ...
    api_client: Optional[HelloAssoApiV5CommonModelsAccountsClientsApiClientModel] = Field(default=None, alias="apiClient")
    url_notification_list: Optional[List[HelloAssoApiV5CommonModelsApiNotificationsApiUrlNotificationModel]] = Field(default=None, description="Url Notification of the partner", alias="urlNotificationList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "apiClient": HelloAssoApiV5CommonModelsAccountsClientsApiClientModel.from_dict(obj["apiClient"]) if obj.get("apiClient") is not None else None,
            "urlNotificationList": [HelloAssoApiV5CommonModelsApiNotificationsApiUrlNotificationModel.from_dict(_item) for _item in obj["urlNotificationList"]] if obj.get("urlNotificationList") is not None else None,
