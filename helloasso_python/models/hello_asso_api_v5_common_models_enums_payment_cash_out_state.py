...
class HelloAssoApiV5CommonModelsEnumsPaymentCashOutState(str, Enum):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of HelloAssoApiV5CommonModelsEnumsPaymentCashOutState from a JSON string"""
