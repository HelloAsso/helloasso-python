...
class HelloAssoApiV5CommonModelsStatisticsOrderDetail(BaseModel):
    """
    HelloAssoApiV5CommonModelsStatisticsOrderDetail
    """ # noqa: E501
    payer: Optional[HelloAssoApiV5CommonModelsStatisticsPayer] = None
    items: Optional[List[HelloAssoApiV5CommonModelsStatisticsOrderItem]] = Field(default=None, description="All items of the order")
    payments: Optional[List[HelloAssoApiV5CommonModelsStatisticsOrderPayment]] = Field(default=None, description="All payments of the order")
    amount: Optional[HelloAssoApiV5CommonModelsStatisticsOrderAmountModel] = None
    ...
    organization_type: Optional[HelloAssoApiV5CommonModelsEnumsOrganizationType] = Field(default=None, alias="organizationType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [HelloAssoApiV5CommonModelsStatisticsOrderItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "payments": [HelloAssoApiV5CommonModelsStatisticsOrderPayment.from_dict(_item) for _item in obj["payments"]] if obj.get("payments") is not None else None,
            "amount": HelloAssoApiV5CommonModelsStatisticsOrderAmountModel.from_dict(obj["amount"]) if obj.get("amount") is not None else None,
            "id": obj.get("id"),
            "date": obj.get("date"),
