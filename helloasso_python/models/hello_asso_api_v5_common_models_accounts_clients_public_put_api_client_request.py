...
class HelloAssoApiV5CommonModelsAccountsClientsPublicPutApiClientRequest(BaseModel):
    """
    HelloAssoApiV5CommonModelsAccountsClientsPublicPutApiClientRequest
    """ # noqa: E501
    domain: Optional[StrictStr] = Field(default=None, description="Client domain : Url used to grant authorization redirection")
