...
class HelloAssoApiV5ModelsStatisticsOrderPayment(BaseModel):
    """
    Payment on the order
    """ # noqa: E501
    items: Optional[List[HelloAssoApiV5ModelsStatisticsShareItem]] = Field(default=None, description="Items linked to this payment and each share between the item and the payment")
    ...
    __properties: ClassVar[List[str]] = ["items", "cashOutDate", "cashOutState", "paymentReceiptUrl", "fiscalReceiptUrl", "id", "amount", "amountTip", "date", "paymentMeans", "installmentNumber", "state", "type", "meta", "paymentOffLineMean", "refundOperations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [HelloAssoApiV5ModelsStatisticsShareItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
