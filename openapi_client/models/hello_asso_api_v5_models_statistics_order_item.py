...
class HelloAssoApiV5ModelsStatisticsOrderItem(BaseModel):
    """
    Item on the order
    """ # noqa: E501
    payments: Optional[List[HelloAssoApiV5ModelsStatisticsSharePayment]] = Field(default=None, description="Payments linked to this item and each share between the item and the payment")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payments": [HelloAssoApiV5ModelsStatisticsSharePayment.from_dict(_item) for _item in obj["payments"]] if obj.get("payments") is not None else None,
            "name": obj.get("name"),
