...
class HelloAssoApiV5ModelsFormsFormPublicModel(BaseModel):
    """
    ...
    tiers: Optional[List[HelloAssoApiV5ModelsFormsTierPublicModel]] = Field(default=None, description="Tiers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tiers": [HelloAssoApiV5ModelsFormsTierPublicModel.from_dict(_item) for _item in obj["tiers"]] if obj.get("tiers") is not None else None,
